...
| Roll-Geske-Whaley | Richard Roll, "An Analytic Valuation Formula for Unprotected American Call Options on Stocks with Known Dividends," *Journal of Financial Economics* 5(2), 1977, pp. 251-258, [doi:10.1016/0304-405X(77)90021-6](https://doi.org/10.1016/0304-405X(77)90021-6); Robert Geske, "A Note on an Analytical Valuation Formula for Unprotected American Call Options on Stocks with Known Dividends," *Journal of Financial Economics* 7(4), 1979, pp. 375-380, [doi:10.1016/0304-405X(79)90017-5](https://doi.org/10.1016/0304-405X(79)90017-5); Robert E. Whaley, "On the Valuation of American Call Options on Stocks with Known Dividends," *Journal of Financial Economics* 9(2), 1981, pp. 207-211, [doi:10.1016/0304-405X(81)90011-5](https://doi.org/10.1016/0304-405X(81)90011-5). | Single-dividend American-call formula, early-exercise condition and critical-price equation. |
...
| Roll-Geske-Whaley | Haug's worked example ($S=80$, $K=82$, $D=4$, $t_D=0.25$, $T=1/3$, $r=0.06$, $\sigma=0.30$), plus the MathWorks single-dividend example. | `1e-4` for Haug's four-decimal value; `5e-4` for MathWorks because its Actual/Actual dates are evaluated through the library's explicit ACT/365F convention. |
