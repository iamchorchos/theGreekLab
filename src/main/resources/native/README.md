...
When the native component is distributed together with the MIT-licensed Java
component, the combined distribution is provided under GPL-3.0-or-later.

Full license texts are stored in the repository `LICENSES` directory and are
included under `META-INF/LICENSES` in the built JAR.
